/**
 * Local equivalent of the exported `engagementReminderDispatch.test.ts`
 * suite: reliability tests for engagement-reminder dispatch.
 *
 * Defects covered:
...
import {
  ...
  dispatchReminders,
  type ReminderEntry,
} from '../src/lab/engagementReminders/dispatch';
