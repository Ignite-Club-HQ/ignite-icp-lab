...
import {
  ...
  isUuid,
  MAX_DELETION_BATCH,
} from "../../supabase/functions/_shared/vaultDeleteRequest";

const SUPABASE_URL = "https://reference.invalid";

const fnSource = readFileSync(
  resolve(__dirname, "../../supabase/functions/permanent-delete-photos/index.ts"),
  "utf8",
);
