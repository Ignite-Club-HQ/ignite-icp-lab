...
import { idlFactory, type _SERVICE } from "./declarations/events_domain_motoko.did";
...
export interface events_domain_motokoInterface {
...
import type { Attendance as _Attendance, Duty as _Duty, Event as _Event, LineupEntry as _LineupEntry, Recurrence as _Recurrence, RoleGrant as _RoleGrant, RosterEntry as _RosterEntry, Rsvp as _Rsvp } from "./declarations/events_domain_motoko.did";
export class Events_domain_motoko implements events_domain_motokoInterface {
...
export function createActor(canisterId: string, options: CreateActorOptions = {}): Events_domain_motoko {
    ...
    return new Events_domain_motoko(actor);
}
