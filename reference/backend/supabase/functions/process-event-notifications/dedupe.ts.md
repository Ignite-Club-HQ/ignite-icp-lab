# Source reference: supabase/functions/process-event-notifications/dedupe.ts
 ...
 * trigger, a duplicated `pg_net` request, a restarted Edge Function, an
 * operator retry or two concurrent invocations all collapse onto the same
